...
import { getData, createData, updateData, deleteData, showData, exportData } from '../Services/SalaryBenefitHistoryService';

export const useSalaryBenefitHistoryStore = create((set, get) => ({
    datas: [],
    detail: [],
    page: 1,
    limit: 10,
