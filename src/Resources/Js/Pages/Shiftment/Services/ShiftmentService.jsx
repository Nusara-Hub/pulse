...
export async function getData(page, limit, search) {
    try {
        const response = await axios.get('/api/pulse/shiftment', {
            params: {
                page: page,
                limit: limit,
                search: search
...
export async function showData(id) {
    try {
        const response = await axios.get('/api/pulse/shiftment/' + id);
        return response.data;
    } catch (error) {
...
export async function createData(data) {
    ...
    if (data) {
        try {
            const response = await axios.post('/api/pulse/shiftment', data);
            return response.data;
        } catch (error) {
...
export async function updateData(id, data) {
    if (data) {
        try {
            const response = await axios.put(`/api/pulse/shiftment/${id}`, data);
            return response.data;
        } catch (error) {
...
export async function deleteData(id) {
    try {
        const response = await axios.delete(`/api/pulse/shiftment/${id}`);
        return response.data;
    } catch (error) {
...
export async function exportData() {
    try {
        const response = await axios.get('/api/pulse/shiftment/export', {
