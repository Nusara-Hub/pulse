...
import { getData, createData, updateData, deleteData, showData, exportData } from '../Services/SalaryAllowanceService';

export const useSalaryAllowanceStore = create((set, get) => ({
    datas: [],
    detail: [],
    page: 1,
    limit: 10,
