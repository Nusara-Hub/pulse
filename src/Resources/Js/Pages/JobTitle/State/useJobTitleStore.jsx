...
import { getData, createData, updateData, deleteData, showData, exportData } from '../Services/JobTitleService';

export const useJobTitleStore = create((set, get) => ({
    datas: [],
    detail: [],
    page: 1,
    limit: 10,
    ...
    fetch: async (id = null) => {
        ...
        set({ loading: true });
        try {
            const data = await getData(page, limit, search, id);
            set({
                datas: data,
