...
import { getData, createData, updateData, deleteData, showData, exportData } from '../Services/SalaryBenefitService';

export const useSalaryBenefitStore = create((set, get) => ({
    datas: [],
    detail: [],
    page: 1,
    limit: 10,
