...
export async function getData(page, limit, search) {
    try {
        const response = await axios.get('/api/pulse/skill', {
            params: {
                page: page,
                limit: limit,
                search: search
...
export async function showData(id) {
    try {
        const response = await axios.get('/api/pulse/skill/' + id);
        return response.data;
    } catch (error) {
...
export async function createData(data) {
    ...
    if (data) {
        try {
            const response = await axios.post('/api/pulse/skill', data);
            return response.data;
        } catch (error) {
...
export async function updateData(id, data) {
    if (data) {
        try {
            const response = await axios.put(`/api/pulse/skill/${id}`, data);
            return response.data;
        } catch (error) {
...
export async function deleteData(id) {
    try {
        const response = await axios.delete(`/api/pulse/skill/${id}`);
        return response.data;
    } catch (error) {
...
export async function exportData() {
    try {
        const response = await axios.get('/api/pulse/skill/export', {
