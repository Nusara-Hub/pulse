...
import { getData, createData, updateData, deleteData, showData, exportData } from '../Services/EducationTitleService';

export const useEducationTitleStore = create((set, get) => ({
    datas: [],
    detail: [],
    page: 1,
    limit: 10,
