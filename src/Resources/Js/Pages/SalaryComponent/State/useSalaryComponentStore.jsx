...
import { getData, createData, updateData, deleteData, showData, exportData } from '../Services/SalaryComponentService';

export const useSalaryComponentStore = create((set, get) => ({
    datas: [],
    detail: [],
    page: 1,
    limit: 10,
